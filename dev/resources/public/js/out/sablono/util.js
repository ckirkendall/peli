...
var x__16985__auto__ = (((x == null))?null:x);
var m__16986__auto__ = (sablono.util.to_str[goog.typeOf(x__16985__auto__)]);
if(!((m__16986__auto__ == null))){
return m__16986__auto__.call(null,x);
} else {
var m__16986__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__16986__auto____$1 == null))){
return m__16986__auto____$1.call(null,x);
} else {
...
var x__16985__auto__ = (((x == null))?null:x);
var m__16986__auto__ = (sablono.util.to_uri[goog.typeOf(x__16985__auto__)]);
if(!((m__16986__auto__ == null))){
return m__16986__auto__.call(null,x);
} else {
var m__16986__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__16986__auto____$1 == null))){
return m__16986__auto____$1.call(null,x);
} else {
...
var len__17388__auto___20649 = arguments.length;
var i__17389__auto___20650 = (0);
while(true){
if((i__17389__auto___20650 < len__17388__auto___20649)){
args__17395__auto__.push((arguments[i__17389__auto___20650]));

var G__20651 = (i__17389__auto___20650 + (1));
i__17389__auto___20650 = G__20651;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17396__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq20648){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20648));
});
/**
...
var vec__20653 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__20653,(0),null);
var words = cljs.core.nthnext.call(null,vec__20653,(1));
...
var G__20655 = clojure.set.rename_keys.call(null,m,kmap);
var G__20655__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__20655,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__20655);
return G__20655__$1;
} else {
return m;
}
...
var args__17395__auto__ = [];
var len__17388__auto___20658 = arguments.length;
var i__17389__auto___20659 = (0);
while(true){
if((i__17389__auto___20659 < len__17388__auto___20658)){
args__17395__auto__.push((arguments[i__17389__auto___20659]));

var G__20660 = (i__17389__auto___20659 + (1));
i__17389__auto___20659 = G__20660;
continue;
} else {
}
break;
...
var argseq__17396__auto__ = ((((0) < args__17395__auto__.length))?(new cljs.core.IndexedSeq(args__17395__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17396__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__20656_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__20656_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20656_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__20656_SHARP_)){
return p1__20656_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20656_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq20657){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20657));
});
/**
...
var vec__20664 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__20664,(0),null);
var names = cljs.core.nth.call(null,vec__20664,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__20664,tag_name,names){
return (function (p1__20661_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__20661_SHARP_));
});})(matches,vec__20664,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__20664,tag_name,names){
return (function (p1__20662_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__20662_SHARP_));
});})(matches,vec__20664,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__20665){
var vec__20668 = p__20665;
var tag = cljs.core.nth.call(null,vec__20668,(0),null);
var content = cljs.core.nthnext.call(null,vec__20668,(1));
...
var vec__20669 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__20669,(0),null);
var id = cljs.core.nth.call(null,vec__20669,(1),null);
var class$ = cljs.core.nth.call(null,vec__20669,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16330__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1446821460217
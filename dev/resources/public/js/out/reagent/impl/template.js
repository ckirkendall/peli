...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16928__auto__,writer__16929__auto__,opt__16930__auto__){
return cljs.core._write.call(null,writer__16929__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16330__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16330__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16330__auto__)){
return or__16330__auto__;
} else {
...
var G__24024 = o;
(G__24024[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_24028 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24028))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24028)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16318__auto__ = (node === document.activeElement);
if(and__16318__auto__){
var and__16318__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16318__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24031 = jsprops;
(G__24031["defaultValue"] = value);

(G__24031["onChange"] = ((function (G__24031,v,value,on_change){
return (function (p1__24029_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24029_SHARP_);
});})(G__24031,v,value,on_change))
);
...
var vec__24033 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24033,(0),null);
var id = cljs.core.nth.call(null,vec__24033,(1),null);
var class$ = cljs.core.nth.call(null,vec__24033,(2),null);
...
var temp__4427__auto__ = (function (){var G__24037 = cljs.core.meta.call(null,v);
var G__24037__$1 = (((G__24037 == null))?null:reagent.impl.template.get_key.call(null,G__24037));
return G__24037__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24039_24040 = v;
var G__24039_24041__$1 = (((G__24039_24040 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24039_24040));
var G__24039_24042__$2 = (((G__24039_24041__$1 == null))?null:(jsprops["key"] = G__24039_24041__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__24045 = cljs.core.meta.call(null,argv);
var G__24045__$1 = (((G__24045 == null))?null:reagent.impl.template.get_key.call(null,G__24045));
return G__24045__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__24046 = (((jsprops == null))?{}:jsprops);
(G__24046["key"] = key);
...
var G__24047 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24047;
continue;
}
} else {
...
var n__17233__auto___24048 = a.length;
var i_24049 = (0);
while(true){
if((i_24049 < n__17233__auto___24048)){
(a[i_24049] = reagent.impl.template.as_element.call(null,(a[i_24049])));
...
var a = cljs.core.into_array.call(null,s);
var n__17233__auto___24051 = a.length;
var i_24052 = (0);
while(true){
if((i_24052 < n__17233__auto___24051)){
var val_24053 = (a[i_24052]);
if((cljs.core.vector_QMARK_.call(null,val_24053)) && ((reagent.impl.template.key_from_vec.call(null,val_24053) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24052] = reagent.impl.template.as_element.call(null,val_24053));

var G__24054 = (i_24052 + (1));
i_24052 = G__24054;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16318__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16318__auto__){
return (ctx["no-key"]);
} else {
return and__16318__auto__;
...
var G__24056 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24056) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24056){
...
//# sourceMappingURL=template.js.map?rel=1446808985900
...
var or__4374__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4374__auto__)){
return or__4374__auto__;
} else {
var or__4374__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4374__auto____$1)){
return or__4374__auto____$1;
} else {
var or__4374__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4374__auto____$2)){
return or__4374__auto____$2;
} else {
var or__4374__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4374__auto____$3)){
return or__4374__auto____$3;
} else {
...
var n__5277__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5277__auto__)){
var c_10953 = (a[i]);
if(cljs.core.truth_((c_10953["cljsIsDirty"]))){
(c_10953["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4972__auto__,writer__4973__auto__,opt__4974__auto__){
return cljs.core._write.call(null,writer__4973__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__10957 = c;
var G__10957__$1 = (((G__10957 == null))?null:(G__10957["props"]));
var G__10957__$2 = (((G__10957__$1 == null))?null:(G__10957__$1["argv"]));
return G__10957__$2;
});
...
var G__10959_10960 = (c["cljsRatom"]);
var G__10959_10961__$1 = (((G__10959_10960 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__10959_10960));

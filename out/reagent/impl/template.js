...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4972__auto__,writer__4973__auto__,opt__4974__auto__){
return cljs.core._write.call(null,writer__4973__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4374__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4374__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4374__auto__)){
return or__4374__auto__;
} else {
...
var G__10965 = o;
(G__10965[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_10969 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_10969))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10969)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4362__auto__ = (node === document.activeElement);
if(and__4362__auto__){
var and__4362__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4362__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__10972 = jsprops;
(G__10972["defaultValue"] = value);

(G__10972["onChange"] = ((function (G__10972,v,value,on_change){
return (function (p1__10970_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10970_SHARP_);
});})(G__10972,v,value,on_change))
);
...
var vec__10974 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10974,(0),null);
var id = cljs.core.nth.call(null,vec__10974,(1),null);
var class$ = cljs.core.nth.call(null,vec__10974,(2),null);
...
var temp__4427__auto__ = (function (){var G__10978 = cljs.core.meta.call(null,v);
var G__10978__$1 = (((G__10978 == null))?null:reagent.impl.template.get_key.call(null,G__10978));
return G__10978__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10980_10981 = v;
var G__10980_10982__$1 = (((G__10980_10981 == null))?null:reagent.impl.template.key_from_vec.call(null,G__10980_10981));
var G__10980_10983__$2 = (((G__10980_10982__$1 == null))?null:(jsprops["key"] = G__10980_10982__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__10986 = cljs.core.meta.call(null,argv);
var G__10986__$1 = (((G__10986 == null))?null:reagent.impl.template.get_key.call(null,G__10986));
return G__10986__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10987 = (((jsprops == null))?{}:jsprops);
(G__10987["key"] = key);
...
var G__10988 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10988;
continue;
}
} else {
...
var n__5277__auto___10989 = a.length;
var i_10990 = (0);
while(true){
if((i_10990 < n__5277__auto___10989)){
(a[i_10990] = reagent.impl.template.as_element.call(null,(a[i_10990])));
...
var a = cljs.core.into_array.call(null,s);
var n__5277__auto___10992 = a.length;
var i_10993 = (0);
while(true){
if((i_10993 < n__5277__auto___10992)){
var val_10994 = (a[i_10993]);
if((cljs.core.vector_QMARK_.call(null,val_10994)) && ((reagent.impl.template.key_from_vec.call(null,val_10994) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10993] = reagent.impl.template.as_element.call(null,val_10994));
...
if(cljs.core.truth_((function (){var and__4362__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4362__auto__){
return (ctx["no-key"]);
} else {
return and__4362__auto__;
...
var G__10997 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10997) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10997){
